[![Build Status](https://travis-ci.org/CSC-IT-Center-for-Science/an as well as module scriptssible-role-fgci-bash.svg)](https://travis-ci.org/CSC-IT-Center-for-Science/ansible-role-fgci-bash)
